...
@Component
public class RequestAcceptionNotification {
    ...
    Logger logger = LoggerFactory.getLogger(RequestAcceptionNotification.class);
    public void notifySellersRequestAcception(UserRequest userRequest) {
